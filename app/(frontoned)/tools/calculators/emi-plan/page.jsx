        ...
        <div className="">
              <div className="mb-5 flex flex-col md:flex-row gap-5 justify-between ">
                      ...
                      <div className="flex justify-between gap-4 ">
                        ...
                        <select
                          className="w-full bg-[var(--rv-primary)] rounded-lg p-2"
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 mb-4">
                <div className="col-span-1  rounded-2xl bg-[var(--rv-primary)] p-5">
                        ...
                        <div className="mb-5">
                            <div className="flex justify-between">
                                ...
                                <input
                                    ...
                                    className="font-semibold text-[var(--rv-white)] w-36 border px-2 py-2 rounded"
                                />
                            </div>
                            <input
                                type="range"
                        ...
                        <div className="mb-5">
                            <div className="flex justify-between">
                                ...
                                <input
                                    ...
                                    className="font-semibold text-[var(--rv-white)] w-20 border px-2 py-2 rounded"
                                />
                            </div>
                            <input
                                type="range"
                    ...
                    {emi && (
                        <div className="mt-40  p-5 rounded-lg shadow">
                            <div className="">
                                <div className="mb-4 text-center flex justify-between">
                                    <h2 className="text-2xl font-bold ">Loan EMI</h2>
                                    <p className="text-2xl font-extrabold text-[var(--rv-white)]">₹{emi.toLocaleString()}</p>
                                </div>
                                <div className="mb-4 text-center flex justify-between">
